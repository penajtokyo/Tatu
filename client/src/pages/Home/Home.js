...
class Home extends Component {
  ...
  artistSignUp = (event) => {
    ...
    event.preventDefault();
      ...
      if (artistInfo.email === "" || artistInfo.password === "" || artistInfo.firstName === "" || artistInfo.lastName === "" || artistInfo.phoneNumber === "" || artistInfo.location === "" ||
    artistInfo.street === "" || artistInfo.city === "" || artistInfo.state === "" || artistInfo.zip === "" || artistInfo.specialization === "" || artistInfo.pricing === "" ) {
      this.errModal();
    } else {
  ...
  userSignUp = (event) => {
    ...
    if (customerInfo.email === "" || customerInfo.password === "" || customerInfo.firstName === "" || customerInfo.lastName === "" || customerInfo.phoneNumber === "") {
      this.errModal();
    } else {
